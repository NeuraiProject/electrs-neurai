...
# WS↔TCP bridge: plaintext WebSocket on 127.0.0.1:60002 → TCP electrs:60001.
# nginx terminates TLS on :50004 and proxies the WS upgrade here.
echo "[entrypoint] starting websockify (127.0.0.1:60002 → electrs:60001)"
websockify 127.0.0.1:60002 electrs:60001 &
